...
58.0% reﬂects our improved implementation of \cite{61_wu2018unsupervised}.2
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{Pic/table1.png} % 图片路径和宽度
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{Pic/table2.png} % 图片路径和宽度
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{Pic/table3.png} % 图片路径和宽度
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{Pic/table4.png} % 图片路径和宽度
